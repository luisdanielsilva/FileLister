...
#ifndef FILELISTER_SWIFT_H
#define FILELISTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FileLister",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10FileLister11AppDelegate")
...
SWIFT_CLASS("_TtC10FileLister16QuickLookManager")
@interface QuickLookManager : NSObject <QLPreviewPanelDataSource, QLPreviewPanelDelegate>
- (NSInteger)numberOfPreviewItemsInPreviewPanel:(QLPreviewPanel * _Null_unspecified)panel SWIFT_WARN_UNUSED_RESULT;
- (id <QLPreviewItem> _Null_unspecified)previewPanel:(QLPreviewPanel * _Null_unspecified)panel previewItemAtIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
